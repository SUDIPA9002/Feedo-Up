...
var ScrollReveal = (function() {
    ...
    function l(e, t) {
        if (
            (void 0 === t && (t = this.pristine), !e.visible && e.revealed && e.config.reset)
        )
    ...
    function i(e, a, t) {
        ...
        f(d, function(e) {
            ...
            l && (this.store.sequences[l.id] = l), !0 !== t &&
    ...
    function R(e, t) {
        for (
            var n = t ? e.node.clientHeight : e.node.offsetHeight,
                ...
                r = 0,
                o = 0,
                s = e.node; isNaN(s.offsetTop) || (r += s.offsetTop),
                        ...
                        var t = function(e) {
                            ...
                            return (
                                (n =
                                    ...
                                    ((t = e.node.scrollTop), e.node.scrollLeft)), { top: t, left: n }
                            );
                        }.call(i, e);
                        e.scroll &&
                            (e.direction = {
